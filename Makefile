...
emscripten: $(SRCS)
	$(EMCC) $(CFLAGS) $(EMFLAGS) $(DEBUGFLAGS) $(SRCS) -o $(EM_TARGET) -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s USE_SDL_MIXER=2 -s SDL2_IMAGE_FORMATS='["png"]' --preload-file data/ $(MAPFLAGS)

emscripten_release: $(SRCS)
	$(EMCC) $(CFLAGS) $(RELEASE_CFLAGS) $(EMFLAGS) $(RELEASEFLAGS) $(SRCS) -o $(EM_TARGET) -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s USE_SDL_MIXER=2 -s SDL2_IMAGE_FORMATS='["png"]' --preload-file data/
